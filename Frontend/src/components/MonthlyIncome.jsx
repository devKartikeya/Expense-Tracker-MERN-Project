...
const MonthlyIncome = ({ user }) => {
    ...
    const exportToPDF = async () => {
        ...
        doc.text("Xpense Tracker – Monthly Income Report", isMobile ? 14 : 40, isMobile ? 40 : 20);
        ...
        doc.save("monthly-income-report.pdf");
    };
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Monthly Income");
    ...
    return (
        <div id="monthly-income" className="w-screen min-h-screen bg-black pt-[100px]">
            ...
            <div className="p-6">
                ...
                <div className="flex justify-center mt-12">
                    <button
                        onClick={goToIncome}
                        className="flex-1 sm:w-auto fixed bottom-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md"
                    >
                        Show Total Income
                    </button>
                </div>
