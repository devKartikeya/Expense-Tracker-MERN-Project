...
const Expenses = ({ user }) => {
        ...
        autoTable(doc, {
            body: [
                [
                    ...
                    "",
                    "",
                    `₹${expenses.reduce((sum, d) => sum + d.total, 0)}`,
                ],
            ],
            theme: "plain",
            styles: {
    ...
    const goToMonthlyExpenses = () => navigate("/monthly-expenses");

    return (
        <div
            id="expenses-list"
            className="w-screen min-h-screen bg-black pt-[100px]"
        >
            ...
            <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mb-12 print:hidden gap-4 sm:mt-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <button
                            onClick={exportToPDF}
                            className="flex-1 bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-lg shadow-md cursor-pointer"
                        >
                            PDF
                        </button>
                        <button
                            onClick={exportToExcel}
                            className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-lg shadow-md cursor-pointer"
                        >
                            Excel
                        </button>
                    </div>
                ...
                <div className="flex justify-center mt-12">
                    <button
                        ...
                        className="flex-1 sm:w-auto fixed bottom-4 bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg shadow-md"
                    >
