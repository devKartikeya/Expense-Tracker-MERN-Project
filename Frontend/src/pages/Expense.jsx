...
const Expense = () => {
  ...
  return (
    <div
      id="expense"
      className="w-screen min-h-screen flex justify-center items-center bg-gradient-to-br from-blue-600 to-blue-800 p-4"
    >
      <form
        className="w-full max-w-md md:max-w-lg lg:max-w-xl bg-white flex flex-col items-center justify-between rounded-3xl shadow-2xl p-6"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full mt-6">
          <button
            type="submit"
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-md transition duration-300"
          >
            Add Expense
          </button>
          <button
            type="button"
            className="flex-1 bg-gray-500 hover:bg-gray-600 text-white font-bold py-3 rounded-xl shadow-md transition duration-300"
            onClick={goBack}
          >
            Go Back
          </button>
